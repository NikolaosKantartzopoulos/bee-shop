			...
			<div id="contactBody" className={styles.contactBody}>
				<div id="forCustomers" className={styles.forCustomers}>
					...
					<div id="forCustomersBlahBlah" className={styles.blahblah}>
						Dear customers of Melefsis shop if you have any questions about our
						products or company do not hesitate to contact with us by email or
						telephone. We would love to help you.
					</div>
				</div>
